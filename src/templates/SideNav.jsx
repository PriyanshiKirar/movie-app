        ...
        <>
            <div className='w-[20%] h-full border-r-2 border-zinc-400 p-10'>
                ...
                <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
                    ...
                    <Link className='hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5'><i className="mr-2 ri-fire-fill"></i> Trending</Link>
                    <Link className='hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5'><i className="mr-2 ri-shining-fill"></i> Popular</Link>
