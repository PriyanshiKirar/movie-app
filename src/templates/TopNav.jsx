...
// import noImage  from '../../public/noImage';
const TopNav = () => {
    ...
    return (
        <div className='w-[80%]  h-[10vh] flex  items-center  mx-auto'>
            ...
            {query.length > 0 && (
                <i onClick={() => setquery("")}
                 className=" text-3xl text-zinc-400 ri-close-fill right-0"></i>

            )}
            <div className='z-[100] absolute w-[41%] max-h-[50vh] bg-zinc-200 top-[13.5%] overflow-auto  rounded '>
                {searches.map((s, i) => (
                   ...
                   duration-300 w-[100%] p-10 flex justify-start items-center border-b-2 gap-4 border-zinc-100'>
                        <img className='w-[13vh] h-[13vh] object-cover rounded shadow-lg'
                            src={s.backdrop_path || s.backdrop_path ?
                                 `https://image.tmdb.org/t/p/original/${s.backdrop_path || 
                             s.profile_path}` :"public/no images.png"
                            }
